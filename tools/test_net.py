...
def perform_test(test_loader, model, test_meter, cfg):
    ...
    for cur_iter, (inputs, labels, video_idx, meta) in enumerate(test_loader):
        ...
        if cfg.DETECTION.ENABLE:
            ...
            if cfg.FEAT_EXTRACT == 'Y':
                ...
                for vid in range(len(meta['narration_id'])):
                    features[meta['narration_id'][vid]] = feat[vid]
    ...
    test_meter.reset()
    if cfg.FEAT_EXTRACT == 'Y':
        return preds, labels, metadata, features
    else:
...
def test(cfg):
    ...
    if cfg.FEAT_EXTRACT == 'Y':
        preds, labels, metadata, features = perform_test(test_loader, model, test_meter, cfg)
        pd.to_pickle(features, os.path.join(cfg.OUTPUT_DIR, 'pre_extracted_features.pkl'))
